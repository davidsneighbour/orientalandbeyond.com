var wpAjaxUrl = 'https://orientalandbeyond.com/wp-admin/admin-ajax.php';var flBuilderUrl = 'https://orientalandbeyond.com/plugins/bb-plugin/';var FLBuilderLayoutConfig = {
	...
	paths : {
		pluginUrl : 'https://orientalandbeyond.com/plugins/bb-plugin/',
		wpAjaxUrl : 'https://orientalandbeyond.com/wp-admin/admin-ajax.php'
	},
	breakpoints : {
		small  : 768,
		medium : 992,
...
(function($) {
	...
	$('.fl-node-57efb1bd5376e .fl-slider-next').empty();
	$('.fl-node-57efb1bd5376e .fl-slider-prev').empty();

	// Create the slider and assign an instance to a variable.
	var testimonials = $('.fl-node-57efb1bd5376e .fl-testimonials').bxSlider({
		autoStart : 1,
		auto : true,
		adaptiveHeight: true,
		pause : 4000,
		...
		speed : 500,
		pager : 0,
		nextSelector : '.fl-node-57efb1bd5376e .fl-slider-next',
		prevSelector : '.fl-node-57efb1bd5376e .fl-slider-prev',
		nextText: '<i class="fas fa-chevron-circle-right"></i>',
		prevText: '<i class="fas fa-chevron-circle-left"></i>',
		controls : 0,
		onSliderLoad: function(currentIndex) {
			$('.fl-node-57efb1bd5376e .fl-testimonials').addClass('fl-testimonials-loaded');
			$('.fl-node-57efb1bd5376e .fl-slider-next a').attr('aria-label', 'Next testimonial.' );
			$('.fl-node-57efb1bd5376e .fl-slider-prev a').attr('aria-label', 'Previous testimonial.' );
		},
		...
		onSlideBefore: function(ele, oldIndex, newIndex) {
			$('.fl-node-57efb1bd5376e .fl-slider-next a').addClass('disabled');
			$('.fl-node-57efb1bd5376e .fl-slider-prev a').addClass('disabled');
			$('.fl-node-57efb1bd5376e .bx-controls .bx-pager-link').addClass('disabled');
		},
		onSlideAfter: function( ele, oldIndex, newIndex ) {
			$('.fl-node-57efb1bd5376e .fl-slider-next a').removeClass('disabled'); 
			$('.fl-node-57efb1bd5376e .fl-slider-prev a').removeClass('disabled'); 
			$('.fl-node-57efb1bd5376e .bx-controls .bx-pager-link').removeClass('disabled');
		},
		onSlideNext: function(ele, oldIndex, newIndex) {
			$('.fl-node-57efb1bd5376e .fl-slider-next').attr( 'aria-pressed', 'true' );
			$('.fl-node-57efb1bd5376e .fl-slider-prev').attr( 'aria-pressed', 'false' );
		},
		onSlidePrev: function(ele, oldIndex, newIndex) {
			$('.fl-node-57efb1bd5376e .fl-slider-next').attr( 'aria-pressed', 'false' );
			$('.fl-node-57efb1bd5376e .fl-slider-prev').attr( 'aria-pressed', 'true' );
		}
	});
