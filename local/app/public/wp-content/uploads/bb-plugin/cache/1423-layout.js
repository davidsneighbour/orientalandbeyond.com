...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-61b81ca85da07 .fl-photo-img' )
...
(function($) {
	...
	$(function() {
			...
			$('.fl-node-iohmn2ljkpdg .fl-mosaicflow-content, .fl-node-iohmn2ljkpdg .fl-gallery').magnificPopup({
				...
				$('.fl-node-iohmn2ljkpdg .fl-mosaicflow-content').one( 'mosaicflow-filled', function(){
	...
	jQuery(document).ready(function(){
		setTimeout(function(){
			jQuery('.fl-node-iohmn2ljkpdg .fl-mosaicflow-content').trigger('resize');
		},50);
	});
})(jQuery);
